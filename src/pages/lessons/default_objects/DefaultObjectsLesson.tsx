  ...
  return (
    <>
      <div className={styles.DefaultObjects_text}>
        ...
        <p>
          9. Date. Объект для работы с датами и временем. Он предоставляет
        ...
        <p>
          10. RegExp. Объект для работы с регулярными выражениями. Он
        ...
        <p>
          11. Error. Объект для создания и обработки ошибок. Он является основой
        ...
        <p>
          12. Map. Коллекция, которая хранит пары "ключ-значение", где ключи
        ...
        <p>
          13. Set. Коллекция уникальных значений, которая может хранить только
        ...
        <p>
          14. WeakMap. Похож на Map, но ключи могут быть только объектами и они
        ...
        <p>
          15. WeakSet. Похож на Set, но в нём могут быть только объекты в
        ...
        <p>
          16. Promise. Объект для работы с асинхронными операциями. Он позволяет
        ...
        <p>
          17. Proxy. Объект, который позволяет перехватывать и изменять
        ...
        <p>
          18. Reflect. Объект для работы с мета-программированием,
        ...
        <p>
          19. Intl. Объект для работы с международными стандартами. Он включает
        ...
        <p>
          20. JSON. Стандартный объект для работы с JSON-данными (JavaScript
        ...
        <p>
          21. console. Объект, предоставляющий методы для вывода информации в
        ...
        <p>
          22. window (для браузера). Глобальный объект, представляющий окно
        ...
        <p>
          23. document (для браузера). Объект, представляющий HTML-документ в
        ...
        <p>
          24. location (для браузера). Объект, предоставляющий информацию о
