  ...
  return (
    <>
      <div className={styles.Primitive_text}>
        ...
        <p>Особенности:</p>
        <p>
          &nbsp;&nbsp;&nbsp;Примитивные значения сравниваются по их содержимому,
          а не по ссылке, как это происходит с объектами.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp;В большинстве случаев примитивные значения хранятся
          в стеке, что делает доступ к ним быстрым.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp;Все примитивные типы, кроме null и undefined, имеют
        ...
        <p>
          &nbsp;&nbsp;&nbsp;Примитивы не являются объектами. Однако при доступе
          к методам (например, "text".toUpperCase()) временно создаётся
          объект-обёртка.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp;Примитивные значения иммутабельны (неизменяемы).
          Любое изменение приводит к созданию нового значения.
        </p>
      </div>
    </>
  )
