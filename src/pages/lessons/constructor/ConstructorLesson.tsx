  ...
  return (
    <>
      <div className={styles.Constructor_text}>
        ...
        <p>&nbsp;&nbsp;&nbsp; 1. Создаётся новый пустой объект.</p>
        <p>
          &nbsp;&nbsp;&nbsp; 2. Этот объект связывается с прототипом
          конструктора (через свойство __proto__).
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; 3. Код внутри конструктора выполняется, часто
          инициализируя свойства нового объекта.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; 4. Функция автоматически возвращает этот объект
          (если не указан другой объект для возврата).
        </p>
        <br />
        <p>
